    ...
    return {
     ...
     methods: {
        ...
        MovieService.updateMovie(this.currentMovie.id , formData).then(response => {
         ...
         retrieveCategory(){
            axios.get('https://heroku-springbackend.herokuapp.com/api/v1/category/admin/list/getAll?isDeleted=false' , { headers: authHeader() } ).then(response => {
        ...
        retrieveCast(){
            axios.get('https://heroku-springbackend.herokuapp.com/api/v1/cast/admin/list/getAll?isDeleted=false' , { headers: authHeader() } ).then(response => {
        ...
        retrieveDirector(){
            axios.get('https://heroku-springbackend.herokuapp.com/api/v1/director/admin/list/getAll?isDeleted=false' , { headers: authHeader() } ).then(response => {
        ...
        retrieveMovieType(){
            axios.get('https://heroku-springbackend.herokuapp.com/api/v1/movie/movietype' , { headers: authHeader() } ).then(response => {
