...
export default {
  ...
  methods :
  {
     getTotalUser()
     {
        axios.get('https://heroku-springbackend.herokuapp.com/api/v1/user/userCount' ,  { headers: authHeader() }).then(response => {
     ...
     getTotalMovie()
     {
        axios.get('https://heroku-springbackend.herokuapp.com/api/v1/movie/movieCount' , { headers: authHeader() }).then(response => {
     ...
     getTotalDirector()
     {
        axios.get('https://heroku-springbackend.herokuapp.com/api/v1/director/directorCount' , { headers: authHeader() }).then(response => {
     ...
     getTotalCast()
     {
        axios.get('https://heroku-springbackend.herokuapp.com/api/v1/cast/castCount' , { headers: authHeader() }).then(response => {
     ...
     getTotalCategory()
     {
        axios.get('https://heroku-springbackend.herokuapp.com/api/v1/category/categoryCount' , { headers: authHeader() }).then(response => {
     ...
     getTotalRevenue()
     {
        axios.get('https://heroku-springbackend.herokuapp.com/api/v1/user/admin/user/sum' , { headers: authHeader() }).then(response => {
     ...
     getTotalUserVip()
     {
        axios.get('https://heroku-springbackend.herokuapp.com/api/v1/user/userVipCount' , { headers: authHeader() }).then(response => {
