...
export default {
  ...
  methods: {
    ...
    getTransactions()
    {
      axios.get('https://heroku-springbackend.herokuapp.com/api/v1/user/admin/user/transaction02' , { headers: authHeader() }).then(response => {
    ...
    getSum() {
      axios.get('https://heroku-springbackend.herokuapp.com/api/v1/user/admin/user/totalnotdeleted' , { headers: authHeader() }).then(response => {
